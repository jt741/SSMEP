...
def get_impedance_frequency_response(model, start_f, stop_f, num):
    frequencies = np.linspace(start=start_f, stop=stop_f, num=num)
...
def end_to_end_get_ar_response(model, start_f=1500, stop_f=5000, num=1000):
